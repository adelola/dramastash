...
latest = List.create(name:"Latest", description:"Recently added to DramaStash", user_id:1)
...
emotions = List.create(name:"Emotional Rollercoaster", description:"Catharis inducing", user_id:1)
